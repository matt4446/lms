...
- [x] T014 [P] [US1] Create E2E test for User Registration flow in `tests/e2e/auth.test.ts`
- [x] T015 [P] [US1] Create E2E test for Course Enrollment flow in `tests/e2e/enrollment.test.ts`
...
- [x] T022 [P] [US2] Install OpenAI Node.js SDK and configure API key in `src/DrillSkill.Web`
- [x] T023 [P] [US2] Create API endpoint `src/routes/api/courses/generate/+server.ts` for AI generation
- [x] T024 [US2] Create "Create Course" Wizard UI (`src/routes/courses/create/+page.svelte`)
- [x] T025 [US2] Implement UI logic to call AI endpoint and display generated outline
- [x] T026 [US2] Implement "Save Course" form action to persist Course and Sections to DB
...
- [x] T027 [P] [US3] Create Course Viewer layout (`src/routes/courses/[id]/learn/+layout.svelte`) with sidebar navigation
- [x] T028 [US3] Implement Section Viewer page (`src/routes/courses/[id]/learn/[sectionId]/+page.svelte`) rendering Markdown content
- [x] T029 [US3] Implement "Mark Complete" form action in Section Viewer
- [x] T030 [US3] Implement server-side check for prerequisites in `load` function (redirect if locked)
- [x] T031 [US3] Add visual indicators for Locked/Completed sections in the sidebar
...
- [x] T032 [P] [US4] Create Exam Editor UI component for Course Owners
- [x] T033 [US4] Create Exam Taker UI (`src/routes/courses/[id]/learn/[sectionId]/exam/+page.svelte`)
- [x] T034 [US4] Implement Exam submission and grading logic (server-side)
- [x] T035 [US4] Create Results Dashboard (`src/routes/courses/[id]/results/+page.svelte`) for Course Owners
- [x] T036 [US4] Update Course Completion logic to check for passed exams
...
- [x] T037 [P] Update `README.md` with setup instructions
- [x] T038 [P] Add error pages (`+error.svelte`) for 404/403/500
- [x] T039 Verify all "Constitution" requirements (Linting, Accessibility check)
- [x] T040 Run full E2E test suite
